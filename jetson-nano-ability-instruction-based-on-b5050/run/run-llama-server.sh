...
#
# Examples:
#   bash ../llama.cpp-b9006/jetson-nano-ability-instruction-based-on-b5050/run/run-llama-server.sh unsloth/Qwen3.5-0.8B-GGUF:Q8_0 -- --n-gpu-layers 99 --port 8776 --host 0.0.0.0 --reasoning-budget 128 --reasoning-budget-message "Time to summarize and answer." --image-max-tokens 570
